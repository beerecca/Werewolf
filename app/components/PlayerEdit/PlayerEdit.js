	...
	render() {
		...
		return (
			<span>
				...
				<button onClick={this.addAnother.bind(this)} className="btn btn-default">Add Another</button>
				<button onClick={startGame} className="btn btn-default">Start Game</button>
			</span>
		);
	}
}
